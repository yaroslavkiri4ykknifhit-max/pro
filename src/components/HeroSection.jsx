    ...
    <section className="relative pt-8 pb-16 md:pt-12 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start space-y-6">
          ...
          {/* Top Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-300/80 bg-white text-xs font-medium text-slate-700 shadow-sm">
            <span>Welcome to Creatiwise</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <Link
              to="/admin"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full border border-slate-300 text-slate-800 font-medium hover:bg-white transition-all shadow-sm"
            >
              <span>Explore Reseller SaaS</span>
            </Link>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 relative flex flex-col items-center lg:items-end">
          ...
          {/* Satisfied Clients Badge (Top Right / Above Photo) */}
          <div className="mb-4 lg:mb-6 self-start lg:self-start bg-white border border-slate-200 shadow-sm rounded-2xl p-3 inline-flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-900 leading-tight">250+ Satisfied</div>
          ...
          <div className="relative w-full max-w-md bg-slate-200 rounded-[2.5rem] overflow-hidden shadow-xl border border-slate-200/80">
            <img
              ...
              alt="Creatiwise Creative Designer"
