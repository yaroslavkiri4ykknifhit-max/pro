...
export function BentoGrid() {
  ...
  return (
    <section id="about" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Top Badge */}
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-300 bg-white text-xs font-semibold text-slate-700 shadow-sm mb-6">
        <span>О нашей платформе</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8">
        ...
        <div className="lg:col-span-7 space-y-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight font-display">
            Creatiwise: Ваш персональный <br className="hidden sm:inline" /> инструмент продаж
          </h2>
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-2xl">
            Мы создали решение, избавляющее от любых сложных баз данных и разработчиков. Вы сами управляете дизайном витрины, добавляете товары, фильтры брендов и получаете готовые заказы с наименованием товара прямо в ваш Telegram.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-slate-300 text-sm sm:text-base font-medium">
                Средний рост конверсии и повторных заказов
              </p>
            </div>
